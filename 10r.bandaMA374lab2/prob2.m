...
%for K = 95
  ...
  fprintf('\n');
  fprintf('The initial value of American(path  dependent) call option for the specifically mentioned data is : %f  \n', call_s01(51));
  fprintf('\n');
  fprintf('The initial value of American(path dependent) put option for the specifically mentioned data is : %f \n', put_s01(51));
  fprintf('\n');
